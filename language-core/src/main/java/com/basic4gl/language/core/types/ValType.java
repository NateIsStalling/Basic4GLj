...
public class ValType implements Streamable {
     ...
     */
    public int[] arrayDimensions = new int[ArrayConstants.ARRAY_MAX_DIMENSIONS];
    ...
    public ValType() {
        setType(BasicValType.VTP_UNDEFINED);
    }
    ...
    public boolean isFuncPtr() {
        return basicType == BasicValType.VTP_FUNC_PTR && pointerLevel == 0 && arrayLevel == 0;
    }
        ...
        if (type < 0) {
            switch (type) {
                ...
                case BasicValType.VTP_NULL:
                    return "null";
                case BasicValType.VTP_UNDEFINED:
                    return "UNDEFINED";
                default:
                    return "???";
            }
    ...
    public ValType setType(int type, byte array, byte pointer, boolean byRef) {
        assertTrue(array <= ArrayConstants.ARRAY_MAX_DIMENSIONS);
        basicType = type;
        arrayLevel = array;
    ...
    public ValType setType(ValType t) {
        ...
        arrayDimensions = Arrays.copyOf(t.arrayDimensions, ArrayConstants.ARRAY_MAX_DIMENSIONS);
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (basicType == BasicValType.VTP_FUNC_PTR && prototypeIndex != valType.prototypeIndex) {
            return false;
        }
    ...
    public boolean isNull() {
        return basicType == BasicValType.VTP_NULL;
    }
    ...
    public void addDimension(int elements) {
        assertTrue(arrayLevel < ArrayConstants.ARRAY_MAX_DIMENSIONS);
    ...
    public void streamOut(DataOutputStream stream) throws IOException {
        ...
        for (int i = 0; i < ArrayConstants.ARRAY_MAX_DIMENSIONS; i++) {
