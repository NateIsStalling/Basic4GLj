package com.basic4gl.app.desktop.glfw;
    ...
    int scanKeyFromGLFWKey(int key, boolean ignoreLeftRight) {
        ...
        switch (key) {
            ...
            case GLFW_KEY_LEFT_ALT:
                return ignoreLeftRight ? VK_MENU : VK_LMENU;
            case GLFW_KEY_RIGHT_ALT:
                return ignoreLeftRight ? VK_MENU : VK_RMENU;
            ...
            case GLFW_KEY_LEFT_SHIFT:
                return ignoreLeftRight ? VK_SHIFT : VK_LSHIFT;
            case GLFW_KEY_RIGHT_SHIFT:
                return ignoreLeftRight ? VK_SHIFT : VK_RSHIFT;
            case GLFW_KEY_LEFT_CONTROL:
                return ignoreLeftRight ? VK_CONTROL : VK_LCONTROL;
            case GLFW_KEY_RIGHT_CONTROL:
                return ignoreLeftRight ? VK_CONTROL : VK_RCONTROL;
            default:
