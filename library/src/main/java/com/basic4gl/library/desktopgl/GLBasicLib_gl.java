...
public class GLBasicLib_gl implements FunctionLibrary {
    ...
    s.put(
        ...
        new FunctionSpecification[] {
          new FunctionSpecification(
              WrapglAccum.class,
              new ParamTypeList(
                  new ValType(BasicValType.VTP_INT), new ValType(BasicValType.VTP_REAL)),
              true,
              false,
  ...
  public final class WrapglGetTexLevelParameterfv implements Function {
    ...
    public void run(TomVM vm) {
      ...
      floatBuffer16.rewind();
      glGetTexLevelParameterfv(
          vm.getIntParam(4), vm.getIntParam(3), vm.getIntParam(2), floatBuffer16);
      floatBuffer16.rewind();
      floatBuffer16.get(a);
      Data.writeArray(
          vm.getData(),
  ...
  public final class WrapglGetTexLevelParameteriv implements Function {
    ...
    public void run(TomVM vm) {
      ...
      intBuffer16.rewind();
      glGetTexLevelParameteriv(
          vm.getIntParam(4), vm.getIntParam(3), vm.getIntParam(2), intBuffer16);
      intBuffer16.rewind();
      intBuffer16.get(a);
      Data.writeArray(
          vm.getData(),
