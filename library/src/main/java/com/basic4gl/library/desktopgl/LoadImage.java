...
public class LoadImage {
  ...
  static int getImageFormat(Image image) {
    ...
    return (image.getBPP() & 0xffff) == 3
        ? GL11.GL_RGB
        : GL11.GL_RGBA; // corona::PF_R8G8B8 ? GL_RGB : GL_RGBA;
  }
  ...
  static Image loadImage(String filename) {
    ...
    // TODO Check image format; Image constructor currently forces RGBA so this step may be
    // unnecessary
    /*
        if (image != null) {
