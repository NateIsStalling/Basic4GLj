...
public class TextBasicLib implements FunctionLibrary, TextAdapter, IGLRenderer {
    ...
    s.put(
        ...
        new FunctionSpecification[] {
          new FunctionSpecification(
              WrapLocate.class,
              new ParamTypeList(
                  new ValType(BasicValType.VTP_INT), new ValType(BasicValType.VTP_INT)),
              false,
              false,
              new ValType(BasicValType.VTP_INT),
              false,
    ...
    s.put(
        ...
        new FunctionSpecification[] {
          ...
          new FunctionSpecification(
              ...
              new ParamTypeList(
                  new ValType(BasicValType.VTP_REAL), new ValType(BasicValType.VTP_REAL)),
              true,
              false,
              new ValType(BasicValType.VTP_INT),
              false,
  ...
  public static void getTiles(
      TomVM vm, int paramIndex, IntBuffer xSize, IntBuffer ySize, Vector<Integer> dest) {
  ...
  public static final class WrapSprPos implements Function {
    public void run(TomVM vm) {
      ...
      vm.getReg()
          .setIntVal(
              Data.fillTempRealArray(vm.getData(), vm.getDataTypes(), 2, Arrays.asList(result)));
    }
  }
  ...
  public static final class WrapSprZOrder implements Function {
    public void run(TomVM vm) {
      vm.getReg()
          .setRealVal(
              TextBasicLib.sprites.isIndexStored(TextBasicLib.boundSprite)
                  ? TextBasicLib.sprites.getValueAt(TextBasicLib.boundSprite).getZOrder()
                  : 0);
    }
  }
  ...
  public static final class WrapSprColour implements Function {
    public void run(TomVM vm) {
      ...
      vm.getReg()
          .setIntVal(
              Data.fillTempRealArray(vm.getData(), vm.getDataTypes(), 4, Arrays.asList(result)));
    }
  }
  ...
  public static final class WrapSprRight implements Function {
    public void run(TomVM vm) {
      if (isSprite(TextBasicLib.boundSprite)) {
        GLSprite sprite = getSprite(TextBasicLib.boundSprite);
        vm.getReg()
            .setRealVal(sprite.positionX + (1 - sprite.centerX) * (sprite.sizeX * sprite.scale));
      } else {
        vm.getReg().setRealVal(0f);
      }
    }
  ...
  public static final class WrapSprBottom implements Function {
    public void run(TomVM vm) {
      if (isSprite(TextBasicLib.boundSprite)) {
        GLSprite sprite = getSprite(TextBasicLib.boundSprite);
        vm.getReg()
            .setRealVal(sprite.positionY + (1 - sprite.centerY) * (sprite.sizeY * sprite.scale));
      } else {
        vm.getReg().setRealVal(0f);
      }
    }
  ...
  public static final class WrapSprXVel implements Function {
    public void run(TomVM vm) {
      vm.getReg()
          .setRealVal(
              isSprite(TextBasicLib.boundSprite) ? getSprite(TextBasicLib.boundSprite).xd : 0);
    }
  }
  ...
  public static final class WrapSprYVel implements Function {
    public void run(TomVM vm) {
      vm.getReg()
          .setRealVal(
              isSprite(TextBasicLib.boundSprite) ? getSprite(TextBasicLib.boundSprite).yd : 0);
    }
  }
  ...
  public static final class WrapSprSpin implements Function {
    public void run(TomVM vm) {
      vm.getReg()
          .setRealVal(
              isSprite(TextBasicLib.boundSprite) ? getSprite(TextBasicLib.boundSprite).angled : 0);
    }
  }
      ...
      vm.getReg()
          .setIntVal(
              isBasicSprite(TextBasicLib.boundSprite)
                  ? getBasicSprite(TextBasicLib.boundSprite).getGLSpriteType().getType()
  ...
  public static final class WrapSprXTiles implements Function {
    public void run(TomVM vm) {
      vm.getReg()
          .setIntVal(isTileMap(boundSprite) ? getTileMap(TextBasicLib.boundSprite).getTilesX() : 0);
    }
  }
  ...
  public static final class WrapSprYTiles implements Function {
    public void run(TomVM vm) {
      vm.getReg()
          .setIntVal(isTileMap(boundSprite) ? getTileMap(TextBasicLib.boundSprite).getTilesY() : 0);
    }
  }
