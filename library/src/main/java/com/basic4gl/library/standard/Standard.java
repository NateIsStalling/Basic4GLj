...
public class Standard implements FunctionLibrary {
    ...
    public Map<String, FunctionSpecification[]> specs() {
        ...
        ///////////////////////
        // Register functions
        s.put("abs", new FunctionSpecification[] {
        ...
        s.put("asc", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapAsc.class,
        ...
        s.put("atn", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapAtn.class,
                    new ParamTypeList(BasicValType.VTP_REAL),
                    true,
        ...
        s.put("chr$", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapChr.class,
        ...
        s.put("cos", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapCos.class,
                    new ParamTypeList(BasicValType.VTP_REAL),
                    true,
        ...
        s.put("exp", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapExp.class,
                    new ParamTypeList(BasicValType.VTP_REAL),
                    true,
        ...
        s.put("int", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapInt.class,
                    new ParamTypeList(BasicValType.VTP_REAL),
                    true,
        ...
        s.put("left$", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapLeft.class,
        ...
        s.put("len", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapLen.class,
                    new ParamTypeList(BasicValType.VTP_STRING),
                    true,
        ...
        s.put("log", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapLog.class,
                    new ParamTypeList(BasicValType.VTP_REAL),
                    true,
        ...
        s.put("mid$", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapMid.class,
        ...
        s.put("pow", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapPow.class,
        ...
        s.put("right$", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapRight.class,
                    new ParamTypeList(BasicValType.VTP_STRING, BasicValType.VTP_INT),
                    true,
        ...
        s.put("rnd", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapRnd.class, new ParamTypeList(), true, true, BasicValType.VTP_INT, false, false, null)
        });
        s.put("sgn", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapSgn.class,
                    new ParamTypeList(BasicValType.VTP_REAL),
                    true,
        ...
        s.put("sin", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapSin.class,
                    new ParamTypeList(BasicValType.VTP_REAL),
                    true,
        ...
        s.put("sqrt", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapSqrt.class,
                    new ParamTypeList(BasicValType.VTP_REAL),
                    true,
        ...
        s.put("sqr", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapSqr.class,
                    new ParamTypeList(BasicValType.VTP_REAL),
                    true,
        ...
        s.put("str$", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapStr.class,
                    new ParamTypeList(BasicValType.VTP_REAL),
                    true,
        ...
        s.put("tan", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapTan.class,
                    new ParamTypeList(BasicValType.VTP_REAL),
                    true,
        ...
        s.put("tanh", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapTanh.class,
                    new ParamTypeList(BasicValType.VTP_REAL),
                    true,
        ...
        s.put("val", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapVal.class,
                    new ParamTypeList(BasicValType.VTP_STRING),
                    true,
        ...
        s.put("sind", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapSinD.class,
                    new ParamTypeList(BasicValType.VTP_REAL),
                    true,
        ...
        s.put("cosd", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapCosD.class,
                    new ParamTypeList(BasicValType.VTP_REAL),
                    true,
        ...
        s.put("tand", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapTanD.class,
                    new ParamTypeList(BasicValType.VTP_REAL),
                    true,
        ...
        s.put("atand", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapATanD.class,
                    new ParamTypeList(BasicValType.VTP_REAL),
                    true,
        ...
        s.put("atnd", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapATanD.class,
                    new ParamTypeList(BasicValType.VTP_REAL),
                    true,
        ...
        s.put("atn2", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapATan2.class,
                    new ParamTypeList(BasicValType.VTP_REAL, BasicValType.VTP_REAL),
                    true,
        ...
        s.put("atn2d", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapATan2D.class,
                    new ParamTypeList(BasicValType.VTP_REAL, BasicValType.VTP_REAL),
                    true,
        ...
        s.put("lcase$", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapLCase.class,
                    new ParamTypeList(BasicValType.VTP_STRING),
                    true,
        ...
        s.put("ucase$", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapUCase.class,
                    new ParamTypeList(BasicValType.VTP_STRING),
                    true,
        ...
        s.put("randomize", new FunctionSpecification[] {
            new FunctionSpecification(
                    ...
                    null),
            new FunctionSpecification(
                    WrapRandomize_2.class, new ParamTypeList(), true, false, BasicValType.VTP_INT, false, false, null)
        });
        s.put("divbyzero", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapDivByZero.class,
                    new ParamTypeList(BasicValType.VTP_REAL),
                    true,
        ...
        // Timer
        s.put("inittimer", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapInitTimer.class, new ParamTypeList(), true, false, BasicValType.VTP_INT, false, false, null)
        });
        s.put("waittimer", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapWaitTimer.class,
                    new ParamTypeList(BasicValType.VTP_INT),
                    true,
        ...
        s.put("synctimer", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapSyncTimer.class,
                    new ParamTypeList(BasicValType.VTP_INT),
                    true,
        ...
        s.put("synctimercatchup", new FunctionSpecification[] {
            new FunctionSpecification(
        ...
        // Program arguments
        s.put("argcount", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapArgCount.class, new ParamTypeList(), true, true, BasicValType.VTP_INT, false, false, null)
        });
        s.put("arg", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapArg.class,
                    new ParamTypeList(BasicValType.VTP_INT),
                    true,
        ...
        // Array size
        s.put("arraymax", new FunctionSpecification[] {
            new FunctionSpecification(
                    WrapArrayMax.class,
