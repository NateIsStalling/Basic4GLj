  ...
  public static String vmOpCodeName(short code) {
    switch (code) {
      ...
      case OP_SAVE_PARAM_PTR:
        return "SAVE_PARAM_PTR";
      case OP_COPY_USER_STACK:
        return "COPY_USER_STACK";
      case OP_MOVE_TEMP:
        return "MOVE_TEMP";
      case OP_CHECK_PTR:
        return "CHECK_PTR";
      ...
      case OP_CONV_INT_REAL:
        return "CONV_INT_REAL";
      case OP_CONV_INT_STRING:
        return "CONV_INT_STRING";
      case OP_CONV_REAL_STRING:
        return "CONV_REAL_STRING";
      case OP_CONV_INT_REAL2:
        return "CONV_INT_REAL2";
      case OP_CONV_INT_STRING2:
        return "CONV_INT_STRING2";
      case OP_CONV_REAL_STRING2:
        return "CONV_REAL_STRING2";
      case OP_OP_OR:
        return "OP_OR";
      case OP_OP_AND:
        return "OP_AND";
      ...
      case OP_CONV_REAL_INT:
        return "CONV_REAL_INT";
      case OP_CONV_REAL_INT2:
        return "CONV_REAL_INT2";
      case OP_RUN:
        return "OP_RUN";
      case OP_BREAKPT:
        return "OP_BREAKPT";
