...
public class Data {
	 ...
	 * @return
	 */
	private static int readArray(Data data, int index, ValType type, byte[] array, int maxSize, int offset) {
		...
		if (elementType.arrayLevel > 0) {
			...
			for (int i = 0; i < elementCount && arrayOffset < maxSize; i++) {
				arrayOffset += readArray(
						data, index + 2 + i * elementSize, elementType, array, maxSize - arrayOffset, arrayOffset);
			}
			return arrayOffset;
	 ...
	 * @return
	 */
	private static int readArray(Data data, int index, ValType type, short[] array, int maxSize, int offset) {
	 ...
	 * @return
	 */
	private static int readArray(Data data, int index, ValType type, int[] array, int maxSize, int offset) {
	 ...
	 * @return
	 */
	private static int readArray(Data data, int index, ValType type, long[] array, int maxSize, int offset) {
	 ...
	 * @return
	 */
	private static int readArray(Data data, int index, ValType type, double[] array, int maxSize, int offset) {
	 ...
	 * @return
	 */
	private static int readArray(Data data, int index, ValType type, float[] array, int maxSize, int offset) {
	...
	public static int readArray(Data data, int index, ValType type, ByteBuffer buffer, int maxSize) {
		...
		if (elementType.arrayLevel > 0) {
			...
			for (int i = 0; i < elementCount && arrayOffset < maxSize; i++) {
				...
				arrayOffset += readArray(data, index + 2 + i * elementSize, elementType, buffer, maxSize - arrayOffset);
			}
			return arrayOffset;
		} else if (elementType.matchesType(BasicValType.VTP_INT)) {
			if (elementCount > maxSize) {
	 ...
	 * @return
	 */
	public static int readArray(Data data, int index, ValType type, DoubleBuffer buffer, int maxSize) {
	...
	public static int writeArray(Data data, int index, ValType type, ByteBuffer buffer, int maxSize) {
		...
		if (elementType.arrayLevel > 0) {
			...
			for (int i = 0; i < elementCount && arrayOffset < maxSize; i++) {
				...
				arrayOffset +=
						writeArray(data, index + 2 + i * elementSize, elementType, buffer, maxSize - arrayOffset);
			}
			return arrayOffset;
		} else if (elementType.matchesType(BasicValType.VTP_INT)) {
			if (elementCount > maxSize) {
	 ...
	 * @return
	 */
	public static int writeArray(Data data, int index, ValType type, ShortBuffer buffer, int maxSize) {
	 ...
	 * @return
	 */
	public static int writeArray(Data data, int index, ValType type, DoubleBuffer buffer, int maxSize) {
	 ...
	 * @return
	 */
	public static int writeArray(Data data, int index, ValType type, FloatBuffer buffer, int maxSize) {
	...
	public static int fillTempRealArray(Data data, TypeLibrary typeLib, int arraySize, float[] array) {
		assertTrue(array != null);
	...
	public static int tempArray2D(Data data, TypeLibrary typeLib, int elementType, int arraySize1, int arraySize2) {
