...
public class Theme {
    ...
    public static final String ICON_NEW = THEME_DIRECTORY + "icon_new_outline.png";
    public static final String ICON_OPEN = THEME_DIRECTORY + "icon_open_outline.png";
    public static final String ICON_SAVE = THEME_DIRECTORY + "icon_save_outline.png";
    public static final String ICON_DEBUG = THEME_DIRECTORY + "icon_debug.png";
    public static final String ICON_PLAY = THEME_DIRECTORY + "icon_play.png";
    public static final String ICON_PAUSE = THEME_DIRECTORY + "icon_pause.png";
