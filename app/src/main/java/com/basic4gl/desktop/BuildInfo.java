...
public class BuildInfo {
    ...
    public static final String APPLICATION_VERSION = "Alpha 0.4.0";
    public static final String APPLICATION_BUILD_DATE = "02/26/2023";
    public static final String APPLICATION_COPYRIGHT = "(c) 2023, Nathaniel Nielsen";
