...
public Token getTokenList(Segment text, int startTokenType, int startOffset) {
	...
	switch (currentTokenType) {
		...
		i = end - 1;
		addToken(
			text, currentTokenStart, i, currentTokenType, newStartOffset + currentTokenStart);
	...
	case Token.LITERAL_STRING_DOUBLE_QUOTE:
		addToken(
			text, currentTokenStart, end - 1, currentTokenType, newStartOffset + currentTokenStart);
		break;
