...
public interface Target {
	 ...
	 */
	public abstract Map<String,List<String>> getSettings();
	...
	/**
	 *
	 * @param settings Collection of properties
	 */
	public abstract void setConfiguration(Map<String,List<String>> settings);
	 ...
	 * @return
	 */
	public abstract OutputStream export();
